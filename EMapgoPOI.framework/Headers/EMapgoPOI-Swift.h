...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EMapgoPOI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("EMapDirectionStyleKit")
@interface EMapDirectionStyleKit : NSObject
/// / Drawing Methods
...
/// :nodoc:
SWIFT_CLASS_NAMED("EMapDirectionView")
@interface EMapDirectionView : UIView
...
@property (nonatomic, copy) NSDictionary<NSString *, NSString *> * _Nonnull stepDic;
