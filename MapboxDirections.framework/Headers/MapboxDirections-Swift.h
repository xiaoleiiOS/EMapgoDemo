...
@property (nonatomic, readonly, copy) NSURL * _Nonnull apiEndpoint;
...
SWIFT_PROTOCOL_NAMED("OfflineDirectionsProtocol")
@protocol MBOfflineDirectionsProtocol
/// Fetches the available versions.
- (NSURLSessionDataTask * _Nonnull)fetchAvailableOfflineVersionsWithCompletionHandler:(void (^ _Nonnull)(NSArray<NSString *> * _Nullable, NSError * _Nullable))completionHandler;
/// Initiates a download process of all tiles needed to provide routing within the given bounding box.
/// \param coordinateBounds The region of the pack to be downloaded.
///
/// \param version The version of the pack to be downloaded.
///
/// \param completionHandler Informs when the download is completed or failed. The offline pack may be moved from the temporary directory and to a persistent store at this point.
///
- (NSURLSessionDownloadTask * _Nonnull)downloadTilesIn:(MBCoordinateBounds * _Nonnull)coordinateBounds version:(NSString * _Nonnull)version session:(NSURLSession * _Nullable)session completionHandler:(void (^ _Nonnull)(NSURL * _Nullable, NSURLResponse * _Nullable, NSError * _Nullable))completionHandler;
@end
...
///
/// returns:
/// A <code>URLSessionDataTask</code>
- (NSURLSessionDataTask * _Nonnull)fetchAvailableOfflineVersionsWithCompletionHandler:(void (^ _Nonnull)(NSArray<NSString *> * _Nullable, NSError * _Nullable))completionHandler;
/// Initializes an <code>URLSessionDownloadTask</code> used for downloading tiles within a given bounding box.
/// \param coordinateBounds The bounding box
///
/// \param version The version to download. Version is represented as a String (yyyy-MM-dd-x)
///
/// \param session Optional URLSession
///
/// \param completionHandler The closure to call with the results
///
///
/// returns:
/// A <code>URLSessionDownloadTask</code>
- (NSURLSessionDownloadTask * _Nonnull)downloadTilesIn:(MBCoordinateBounds * _Nonnull)coordinateBounds version:(NSString * _Nonnull)version session:(NSURLSession * _Nullable)session completionHandler:(void (^ _Nonnull)(NSURL * _Nullable, NSURLResponse * _Nullable, NSError * _Nullable))completionHandler;
@end
...
///
/// \param isUsable The flag to indicate that the upcoming maneuver can be completed with a lane component.
///
...
///
/// \param options The options used when requesting the route.
///
